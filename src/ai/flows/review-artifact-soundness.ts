...
export async function reviewArtifactSoundness(input: ReviewArtifactInput): Promise<ReviewArtifactOutput> {
...
`;
        ...
        throw new Error((lastErr && lastErr.message) || 'The AI failed to return a valid artifact review result.');
    },
);
