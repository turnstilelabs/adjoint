...
export async function GET(req: NextRequest) {
    ...
    return runWithLlmContext(ctx, async () => {
        try {
            ...
            console.info(`[AI][req] source=proof.attempt-sse.get provider=${provider} model=${model} hasKey=${hasKey}`);
        } catch { }
...
export const POST = quietAppRoute(appRoute(attemptProofCompositeFlow) as any);
