...
export const metadata: Metadata = {
  title: 'The Adjoint',
  description: 'Your canonical companion in proof.',
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Spectral:wght@400;500;700&family=Source+Code+Pro&display=swap" rel="stylesheet" />
